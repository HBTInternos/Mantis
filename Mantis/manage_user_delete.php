...
$variable=user_validar_eliminacion_HBT($f_user_id); // ADD HBT 

/**
 *  Se agrega validación para no permitir eliminar un usuario 
 * si este esta asociado a una incidecnia ya sea por que 
 * el la reporto por que la tenga asigna o porque alla dejado 
 * una nota en alguna incidecnia
 */
...
if($variable){
	...
	helper_ensure_confirmed(
		sprintf( 'No es posible eliminar el usuario, debido a que tiene incidencias asociadas o esta vinculados en notas realizadas en las incidencias',
