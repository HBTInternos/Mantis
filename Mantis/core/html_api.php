...
// ADD HBT
function print_menu_summary( array $p_menu_items, $p_current_page = '', $p_event = null ) {
	echo '<ul class="nav nav-tabs padding-18">' . "\n";
	$var="summary_link";
	$var2=0;
	foreach( $p_menu_items as $t_item ) {
	...
	echo '<li >';
	echo '<a href="print_all_bug_page.php"> Imprimir informe </a>';
	echo '</li>', "\n";
...
function print_summary_menu( $p_page = '', array $p_filter = null ) {
	...
	// HBT print_menu( $t_pages, $p_page, 'EVENT_MENU_SUMMARY' ); orignal
	print_menu_summary( $t_pages, $p_page, 'EVENT_MENU_SUMMARY' ); /* HBT Modificacion  */
