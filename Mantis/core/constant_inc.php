...
// ADD HBT
define ('FECHA_NO_LABORABLE',56 );
define ('FECHA_INICIO_MAYOR_FECHA_FIN',57 );
define ( 'ERROR_RESOLUTION_RESOLVED_CLOSED',	 5000);
define ( 'ERROR_RESOLUTION_EMPTY',	 5002);	
define( 'ERROR_STEP_VALIDATION',1308);
define( 'ERROR_LDAP_EXTENSION_NOT_LOADED', 1404 );
#Reqto 805 ERROR ARCHIVO ADJUNTO

define('ERROR_NO_FILE_SPECIFIED_REQUERIDO', 5003);
define ('ERROR_NO_FILE_SPECIFIED_ADJUNTO', 5004);
// define( 'ERROR_STEP_VALIDATION',1308); Dejar comentado despues no compila el proyecto
// FIN ADD HBT
