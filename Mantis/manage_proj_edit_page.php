...
<div style="    background: #615c5c85;"  class="widget-header widget-header-small">
		...
		<fieldset>
			...
			if( file_is_uploading_enabled() && DATABASE !== config_get( 'file_upload_method' ) ) {
				...
				<tr>
					...
					<td> <!-- HBT colocar input en readonly="" -->
						<input type="text" id="project-file-path" name="file_path" readonly=""
