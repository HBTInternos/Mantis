...
<div class="col-md-12 col-xs-12">
				...
				<div class="widget-toolbox padding-8 clearfix">
					<div class="btn-toolbar">
						<div class="btn-group pull-left">
							...
							// add HBT
							print_small_button('HBT_informe_tiempo_incidencia.php' . '?project_id=' . $t_current_project, lang_get('informe_tiempo_incidencias'));
							// fin add HBT
	...
	<footer>
    <nav id="barra-estados">
        <ul class="list-unstyled list-inline text-center">
            <li class="estado-item">
                <span class="color-box estado-nueva"></span>Nueva
            </li>
            <li class="estado-item">
                <span class="color-box estado-incompleto"></span>Se necesitan más datos
            </li>
            <li class="estado-item">
                <span class="color-box estado-aceptada"></span>Aceptada
            </li>
            <li class="estado-item">
                <span class="color-box estado-confirmada"></span>Confirmada
            </li>
            <li class="estado-item">
                <span class="color-box estado-asignada"></span>Asignada
            </li>
            <li class="estado-item">
                <span class="color-box estado-resuelta"></span>Resuelta
            </li>
			<li class="estado-item">
                <span class="color-box estado-cerrada"></span>Cerrada
            </li>
        </ul>
    </nav>
</footer>
