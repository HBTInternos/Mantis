...
require_api( 'bug_api.php' ); // ADD HBT 
...
// HBT captura de $t_impact_analysis
if($control_project == 'control de'){
	
	$t_impact_analysis = gpc_get_int( 'impact_analysis', null );
	if( $t_impact_analysis != null ) {
		$t_issue['impact_analysis'] = $t_impact_analysis;
	}
} // FIN HBT
